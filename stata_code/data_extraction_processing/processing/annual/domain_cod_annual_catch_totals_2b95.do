...
bysort dom1: sum sum_p95_flag sum_trim_95
...
preserve
keep strat_id psu_id id_code wp_catch_95 dom1
/* here there may be multiple rows that differ only in common. once those are dropped, they are duplicates */
duplicates drop
save "${data_intermediate}\adjusted_cod_wp_catch_${vintage_string}.dta", replace
restore
